		...
		function base_barrel()
		{
			...
			$value				= array
						(
							...
							'base_comp'		=> @ base_comp((string) FUSION_DEFAULT_THEME),
							'base_font'		=> @ base_font(),
							'base_image'	=> @ base_image(),
							'base_page'		=> @ base_page((string) FUSION_DEFAULT_THEME),
							...
							'base_widget'	=> @ base_widget((string) FUSION_DEFAULT_THEME)
						);
