...
<link href="<?php echo $params['base_theme_horizontal'];?>assets/css/icons.css" rel="stylesheet" type="text/css">
<link href="<?php echo $params['base_theme_horizontal'];?>assets/css/components.css" rel="stylesheet" type="text/css">
<link href="<?php echo $params['base_theme_horizontal'];?>assets/css/pages.css" rel="stylesheet" type="text/css">
<link href="<?php echo $params['base_theme_horizontal'];?>assets/css/menu.css" rel="stylesheet" type="text/css">
