            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">INVOICE ISI SALDO T-MONEY</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="<?php echo @ site_url('frontend/dashboard'); ?>">Plasa Telkom</a></li>
                                    <li><a href="<?php echo @ site_url('frontend/transaction/topup-account'); ?>">Isi Saldo</a></li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="clearfix">&nbsp;</div>
                                            <div class="col-md-12">
                                            	<div class="col-md-4">Nilai Topup</div>
                                        ...
                                        <div class="row" style="border-radius: 0px">
                                            <div class="col-md-3 col-md-offset-9">
                                                <p class="text-right"><b>Nilai Topup :</b> <?php echo (isset($transaction['amount'])) ? @ formatter_currency($transaction['amount']) : @ formatter_currency(0); ?></p>
                                        ...
                                        <div class="hidden-print">
                                            <div class="pull-right">
                                                ...
                                                <a href="<?php echo @site_url('frontend/transaction/topup-account'); ?>" class="btn btn-danger waves-effect waves-light">Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
