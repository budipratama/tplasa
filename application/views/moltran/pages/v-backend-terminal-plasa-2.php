                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="new_id_admin" class="control-label">Tariff Template</label>
                                            <select class="form-control" name="terminal_trf_template" id="terminal_trf_template">
                                                <option value="">Pilih Tariff</option>
                                                <option value="1" select="selected">Tarif Default PLASA TELKOM</option> 
                                            </select>
                                        </div>
                                    </div> 
                                </div> -->                                
