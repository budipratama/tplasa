        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <div class="panel-body" style="padding-top:0px">
                 	<form method="post" action="<?php echo @ site_url('authentication/user/unlock-screen'); ?>" role="form" class="text-center">
	                    <div class="user-thumb">
	                        <img src="<?php echo $params['base_image']; ?>ravi-vendra.png" class="img-responsive img-circle img-thumbnail" alt="thumbnail">
	                    </div>
